...
The file-version-references in the filenames are necessary, because native libraries will have DLL-hell-issues if different versions of those native libraries are installed and used at the same time.
